...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/4e49" \
       +incdir+"$ref_dir/../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/5765/hdl" \
       +incdir+"../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/4e49" \
       +incdir+"../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../PID_CPU_FINAL.gen/sources_1/bd/system/ipshared/5765/hdl" \
       +incdir+"E:/FPGA_folder/Xilinix/Vivado/2022.1/data/xilinx_vip/include"
}
