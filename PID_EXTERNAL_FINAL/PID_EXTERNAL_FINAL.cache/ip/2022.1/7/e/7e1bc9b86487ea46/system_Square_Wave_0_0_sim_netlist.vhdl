...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Square_Wave is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Square_Wave;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Square_Wave is
  ...
  signal tick_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal \NLW_tick_reg[28]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\tick_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_tick_reg[28]_i_1_CO_UNCONNECTED\(3),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Square_Wave
     port map (
      M_AXIS_tdata(13 downto 0) => \^m_axis_tdata\(13 downto 0),
      clk => clk,
