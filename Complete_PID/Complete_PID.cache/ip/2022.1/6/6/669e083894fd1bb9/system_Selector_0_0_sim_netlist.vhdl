...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_Selector_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Selector is
  port (
    ...
    led_info : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Selector is
  ...
  signal \S_valid[0]_i_4_n_0\ : STD_LOGIC;
  signal \S_valid[0]_i_5_n_0\ : STD_LOGIC;
...
begin
\S_valid[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
\S_valid[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\S_valid[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AB00"
    )
        port map (
...
\S_valid[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\S_valid[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"04FF"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "system_Selector_0_0,Selector,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "Selector,Vivado 2022.1";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Selector
     port map (
      ...
      clk => clk,
      led_info(1 downto 0) => led_info(1 downto 0),
